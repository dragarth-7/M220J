...
public class Migrator {
  ...
  private static UpdateOneModel<Document> transformRating(Document doc) {
    try {
      ...
      return new UpdateOneModel<Document>(new Document("_id", doc.getObjectId("_id")), new
      Document("$set", new Document("imdb.rating", rating)));
  ...
  public static void main(String[] args) {
    ...
    String mongoUri = "mongodb+srv://m220student:m220password@cluster0-scezc.mongodb.net/test";
    ...
    Bson dateStringFilter = new Document("$type", Arrays.asList("string"));
    ...
    // format pattern
    Document queryFilter = new Document("lastupdated",
              dateStringFilter);
    ...
    Bson ratingStringFilter = new Document("imdb.rating", dateStringFilter);
